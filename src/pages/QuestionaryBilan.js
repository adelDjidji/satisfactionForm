...
export default function Questionary(props) {
  ...
  const questionList_part2 = [
    "Comment évaluez-vous l'accompagnement reçu par notre cabinet tout au long de cette exercice ?",
    "Comment évaluez-vous le travail réalisé par notre cabinet pour la production du bilan comptable de votre société ?",
    "Êtes-vous satisfait du bilan comptable de votre société ?",
  ...
  return (
    <div style={{ padding: "3em" }}>
      ...
      <br />
      <Title level={3}>
        Le formulaire de satisfaction pour mesurer la qualité de nos bilans
      </Title>
      <br />
      <Row>
        <Col span={12}></Col>
